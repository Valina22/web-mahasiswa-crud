...
|
*/
$config['sess_driver'] = 'files';  // Menggunakan file untuk menyimpan session
$config['sess_cookie_name'] = 'ci_session';
$config['sess_expiration'] = 7200;  // Waktu expired session (2 jam)
$config['sess_save_path'] = sys_get_temp_dir(); // Tempat penyimpanan session
$config['sess_cookie_name'] = 'ci_session';
